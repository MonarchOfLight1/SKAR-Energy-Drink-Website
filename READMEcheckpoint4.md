...
3. ENDPOINT for logging out  (REQUIRES AUTHENTICATION)
...
Note To professor:  
    we have got 10 api endpoints but only 7 out of 10 are functional endpoints, we will remove the unused endpoints in our next checkpoint.
    Unused endpoints:
    api/product.php
    api/review.php
    api/remove_item.php
